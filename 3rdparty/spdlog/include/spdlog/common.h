...
template <class T> using remove_cvref_t = typename std::remove_cv<typename std::remove_reference<T>::type>::type;
...
template <typename... Args> using wformat_string_t = fmt::wformat_string<Args...>;
#endif
