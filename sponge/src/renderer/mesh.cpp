...
void Mesh::optimize() {
    ...
    indices.insert(indices.end(), optimalIndices.begin(), optimalIndices.end());

    vertices.clear();
    vertices.resize(optimalVertexCount);
    vertices.insert(vertices.end(), optimalVertices.begin(),
                    optimalVertices.end());
}
