...
bool SDLKeyboard::isKeyPressed(const KeyCode key) {
    return state[mapKeyCodeToScanCode(key)] != 0;
}

void SDLKeyboard::initializeScanCodeMap() {
...
void SDLKeyboard::initializeKeyCodeMap() {
...
KeyCode SDLKeyboard::mapScanCodeToKeyCode(const SDL_Scancode& scancode) {
